            ...
            <div class="center">
                <div class="feed_con">
                    <?php       $postID = $_GET['post_id'];
                                $sel_post = mysqli_query($conn, "SELECT * FROM publication WHERE id = '$postID' ORDER BY date DESC") or die("query failed");
                                ...
                                <div class="newsfeed">
                                    ...
                                    <div class="comment_con">
                                        <div class="comment_wrap">
                                            <?php $select_com = mysqli_query($conn, "SELECT * FROM `comments` WHERE post_id = '$post_id' ORDER BY date DESC") or die('select failed');
